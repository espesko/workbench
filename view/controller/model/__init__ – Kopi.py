...
#engine = create_engine("sqlite:///export.db")#, echo=True)
#engine = create_engine("postgresql+psycopg2://postgres:werwer@localhost/wb")#, echo=True)
...
class model(object):
    def __init__(self, database):
        ...
        self.DeclarativeBase = declarative_base(engine)
    ...
    class Sample(model.DeclarativeBase):
    ...
    class VarDB(self.DeclarativeBase):
    ...
    class Frequency(self.DeclarativeBase):
